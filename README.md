...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/misic-napari-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15380&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/misic-napari-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `misic-napari` can be installed with:

```
conda install misic-napari
```

It is possible to list all of the versions of `misic-napari` available on your platform with:
